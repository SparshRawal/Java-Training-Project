...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="row">
           ...
           <%
           		if(LoginHandler.getName()==null && AdminLoginHandler.getName()==null){%>User<%}
           	%>
           <%   
           		if(LoginHandler.getName()!=null && AdminLoginHandler.getName()==null){%> <%=LoginHandler.getName()%> ( <%=LoginHandler.getUser_ID()%>)<%}
           %>
           <%
           		if(LoginHandler.getName()==null && AdminLoginHandler.getName()!=null){%> <%=AdminLoginHandler.getName()%> ( <%=AdminLoginHandler.getAdmin_ID()%>)<%}
