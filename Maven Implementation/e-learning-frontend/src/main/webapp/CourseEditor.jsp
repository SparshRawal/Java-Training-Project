...
<body>
	<div class="container">
		<div class="jumbotron">
			<h2 style="text-align: center">Course Editing</h2>
			<br>
			<div class="container">
				<form action="HandleEditCourse" class="form-horizontal" method="POST">
					...
					<div class="form-group row">
							...
							<label class="col-sm-2 mr-3" style="text-align: left">Parameter
								</label></strong>
							<div class="col-sm-3 ml-5"><strong>Old Value</strong></div>
						...
						<div class="col-sm-2"></div>
							<label class="col-sm-2" for="name" style="text-align: left">Course
								Name:</label>
							<div class="col-sm-3"><%=CourseDetails.getCourse_name() %></div>
							<div class="col-sm-5">
						...
						<div class="form-group row">
							...
							<label class="col-sm-2" for="feedback" style="text-align: left">Course
								Description:</label>
								<div class="col-sm-3"><%=CourseDetails.getCourse_Desc() %></div>
							<div class="col-sm-5">
						...
						<div class="form-group row">
							...
							<label class="col-sm-2" for="file" style="text-align: left">Upload
								Course Resources:</label>
								<div class="col-sm-3"><%=CourseDetails.getCourse_Resource() %></div>
						...
						<div class="form-group row">
							...
							<label class="col-sm-2" for="email" style="text-align: left">Course
								Fees:</label>
								<div class="col-sm-3"><%=CourseDetails.getCourse_Fee() %></div>
							<div class="col-sm-5">
